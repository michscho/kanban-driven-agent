  ...
  const todoInterface = (
    <>
      <div className="header">
        {/* Feature flag: show settings button before agent branding */}
        {settingsAboveAgent && settingsButton}
        <HeaderBrand />
        <div className="header-right">
          ...
          {/* Show settings button in original position when feature flag is not active */}
          {!settingsAboveAgent && settingsButton}
        </div>
      </div>
