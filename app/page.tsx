...
export default function Home() {
  ...
  const isAlwaysFloating = useFeature('das-kanban-board-sollte-immer-floating-sein-ber-de');
  ...
  return (
    <div className="app">
      ...
      <div className={`todo-floating-container ${minimized ? 'minimized' : ''} intro-v2-board todo-floating-top-spacing todo-floating-transparent ${isAlwaysFloating ? 'todo-always-floating' : ''}`}>
        {todoInterface}
      </div>
      ...
      <section className="intro-hero">
        <div className="intro-hero-content">
          ...
          <div className="intro-hero-cta">
            ...
            <GitHubLink className="intro-btn-secondary" />
          </div>
        </div>
      </section>
